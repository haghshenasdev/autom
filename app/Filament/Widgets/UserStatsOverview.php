...
class UserStatsOverview extends BaseWidget
{
    ...
    protected function getStats(): array
    {
        ...
        return [
            ...
            })->count()))->icon('heroicon-o-envelope'),
            Stat::make('ارجاع بررسی نشده', $this->formatShortNumber(Referral::query()->where('to_user_id',$auth_id)->whereNot('checked',1)->count()))->icon('heroicon-o-user'),
            Stat::make(' کار پوشه بررسی نشده', $this->formatShortNumber(Cartable::query()->where('user_id',$auth_id)->whereNot('checked',1)->count()))->icon('heroicon-o-user'),
