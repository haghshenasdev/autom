...
class ContentGroupPolicy
{
     ...
     *
     * @param  \App\Models\User  $user
     * @param  \App\Models\ContentGroup  $content_group
     * @return bool
     */
    public function view(User $user, ContentGroup $content_group): bool
    {
     ...
     * @return bool
     */
    public function update(User $user, ContentGroup $content_group): bool
    {
     ...
     * @return bool
     */
    public function delete(User $user, ContentGroup $content_group): bool
    {
     ...
     * @return bool
     */
    public function forceDelete(User $user, ContentGroup $content_group): bool
    {
     ...
     * @return bool
     */
    public function restore(User $user, ContentGroup $content_group): bool
    {
     ...
     * @return bool
     */
    public function replicate(User $user, ContentGroup $content_group): bool
    {
