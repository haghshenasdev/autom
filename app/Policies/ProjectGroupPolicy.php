...
class ProjectGroupPolicy
{
     ...
     */
    public function view(User $user, ProjectGroup $projectGroup): bool
    {
     ...
     */
    public function update(User $user, ProjectGroup $projectGroup): bool
    {
     ...
     */
    public function delete(User $user, ProjectGroup $projectGroup): bool
    {
     ...
     */
    public function forceDelete(User $user, ProjectGroup $projectGroup): bool
    {
     ...
     */
    public function restore(User $user, ProjectGroup $projectGroup): bool
    {
     ...
     */
    public function replicate(User $user, ProjectGroup $projectGroup): bool
    {
