...
class TaskGroupPolicy
{
     ...
     *
     * @param  \App\Models\User  $user
     * @param  \App\Models\TaskGroup  $task_group
     * @return bool
     */
    public function view(User $user, TaskGroup $task_group): bool
    {
     ...
     * @return bool
     */
    public function update(User $user, TaskGroup $task_group): bool
    {
     ...
     * @return bool
     */
    public function delete(User $user, TaskGroup $task_group): bool
    {
     ...
     * @return bool
     */
    public function forceDelete(User $user, TaskGroup $task_group): bool
    {
     ...
     * @return bool
     */
    public function restore(User $user, TaskGroup $task_group): bool
    {
     ...
     * @return bool
     */
    public function replicate(User $user, TaskGroup $task_group): bool
    {
