...
TEXT;
    ...
    private function handleMinute_create($caption,$chatId,$user,$isPrivateChat)
    {
        ...
        try {
            ...
            $content = $this->AiChat(<<<EOT
 اطلاعات زیر و خطای سیستم را بررسی کن و با توجه به این دو مورد پیشنهاد اصلاح پیام و توضیح خلاصه و مناسب برای کاربر بده و اصلا نیازی به توضیحات فنی نیست.
