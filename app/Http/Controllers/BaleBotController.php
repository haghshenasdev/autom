...
TEXT;
    ...
    private function handleMinute_create($caption,$chatId,$user,$isPrivateChat)
    {
        ...
        try {
            ...
            $content = $this->AiChat(<<<EOT
 اطلاعات زیر و خطای سیستم بررسی کن و با توجه به این دو مورد پیشنهاد اصلاح پیام را بده ، توضیح کوتاه و مناسب برای کاربر بده و اصلا نیازی به توضیحات فنی نیست.
