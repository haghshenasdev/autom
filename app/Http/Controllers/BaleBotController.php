...
اگر اعتبار ریالی ذکر شد با $  و عددی جدا شود. مانند $100000 ریال . اگر اعتباری نبود نیاز نیست از $ استفاده کنی .
متن و اطلاعات هر مصوبه در یک خط باشند.
جا هایی که مهلت برای انجام مشخص شده را به صورت تا 3 روز یا تا 10 ماه یا 1 سال آینده بنویس شروع تاریخت برای حساب کردن مدت لازم از تاریخ {$jalaliD} باشه .اونایی که هیچ مدتی براشون مشخص نشده چیزی نمیخواد بزنی .
