...
class CategoryPredictor
{
    ...
    protected array $blacklist = [
        'تبریک','مبارک', 'گرامی باد','تسلیت', 'صحن', 'ویدیو','فیلم','#فیلم', '#ویدیو', 'ببینید', '#ببینید','بازتاب','#پیشنهاد_تماشا', 'خبرگزاری', 'تصویر -','#پوشش_زنده', 'تسنیم', 'فارس', 'نامه','جلسه علنی','بازتاب','صدا و سیما','مشروح','خانه ملت','ایرنا','ایسنا','میزان','نسیم','دیده بان','دیده‌بان','@YjcNewsChannel','تذکرات کتبی','تذکر کتبی'
    ];
